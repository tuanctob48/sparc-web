    ...
    <div class="container">
        ...
        <div class="meNu">
            <ul>
                ...
                <li>
                    <a href="{{url('/infomation')}}">thông tin</a>
                    <ul id="submenu">
                ...
                <li>
                    <a href="{{url('/study')}}">Học tập</a>
                    <ul id="submenu">
                        <li><a href="{{url('/electronic_techique')}}">Kỹ thuật điện tử</a></li>
                        <li><a href="{{url('/mechanic_techique')}}">Kỹ thuật cơ</a></li>
                        <li><a href="{{url('/programing_techique')}}">Kỹ thuật lập trình</a></li>
                        <li><a href="{{url('/softskill')}}">Kỹ năng mềm</a></li>
                        <li><a href="{{url('/artificial_intelligent')}}">Trí tuệ nhận tạo</a></li>
                        <li><a href="{{url('/references')}}">Sách tham khảo</a></li>
                    </ul>
                </li>
                <li>
